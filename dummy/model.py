...
class CropRecommendationSystem:
    ...
    def _create_crop_dataset(self, n_samples=2000):
        ...
        print(f"📊 Created sample dataset with {len(crop_profiles)} crops")
        return df
    ...
    def preprocess_data(self, df):
        ...
        if 'Crop Name' in df.columns:
            ...
            print(f"🌾 Available crops: {self.crop_names}")
    ...
    def train_model(self, df):
        ...
        print(f"🔍 Hyperparameter search: {n_iter} iterations, {cv_folds}-fold CV")
    ...
    def save_model(self, filepath='crop_recommendation_model.joblib'):
        ...
        print(f"💾 Crop recommendation model saved to {filepath}")
    ...
    def run_pipeline(self, filename='dataset.csv', save_model=True):
        ...
        if 'Crop Name' not in df.columns:
            ...
            if possible_targets:
                ...
                print(f"🔄 Using '{target_col}' as crop name column")
            else:
        ...
        print(f"\n🎉 Crop recommendation system ready in {total_time:.2f}s")
